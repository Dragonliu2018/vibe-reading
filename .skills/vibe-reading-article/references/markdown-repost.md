...
| 原文无"相关阅读" | 博客在末尾**追加** `## 相关阅读` 章节（见下「相关阅读」节），关联博客内同主题/同作者的其他文章 |
...
contentType: "Blogs"                   # Official/Informal/Blogs 末级一律 Blogs；版本化 Docs 用 "Docs"
tags: ["原文标签或主题词"]
...
```markdown
> **原文** [标题](url) · **作者** xxx · **来源** 知乎/公众号 · **原文发布** 2026-07-10 · **转载** 2026-07-24
...
转载文章在原文末尾**追加** `## 相关阅读` 章节（"完全照搬原文"的唯一例外——导言来源标注、`[^err]` 脚注、相关阅读三者为博客自行追加，非原文内容）。

关联博客内其他相关文章，不引外部链接（外部参考属原文内容，已在正文中）：

- **同主题**：博客内解读/转载的同一技术主题的其他文章（如转载了某篇 Doris compaction 文章，关联博客里 Doris compaction 相关的 PR 解读或论文解读）。
- **同作者**：同一原作者的其他转载文章。
- **配对文章**：若有博客自己写的该主题解读/PR 文章，关联为"解读 ↔ 转载原文"配对。

格式与关系标签词表见 `content-guide.md`「通用写作要点·相关阅读」。数量 3–5 条，若无相关文章则省略本节（不硬凑）。
...
```markdown
> **原文** [Original Title](url) · **作者** xxx · **来源** 官方文档/博客 · **原文发布** 2025-12-01 · **中英对照·AI 译** 2026-07-25
