...
| # | 章节 | 是否必填 | 说明 |
|---|------|---------|------|
| 1 | 背景 | ✅ 必填 | PR/commit 的来龙去脉，可参考对应 Issue |
...
<!-- 可选：当前 PR/commit 明确未解决、需后续跟进的问题
     注意：后续发现的 bug 不属于此处 -->
