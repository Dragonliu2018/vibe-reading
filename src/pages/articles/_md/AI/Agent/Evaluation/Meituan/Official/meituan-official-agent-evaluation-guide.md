...
> **原文** [Agent评测漫谈 —— 由浅入深讲解Agent评测](https://mp.weixin.qq.com/s/gZKWRqznB8sNBFf69fBIvw) · **作者** 图灵Agent评测 · **来源** 美团技术团队 微信公众号 · **原文发布** 2026-08-06 · **转载** 2026-09-14
...
本篇博客在美团内部发表之后获得了较多的关注，我们发现大家对Agent评测的热情非常高，因此我们决定将内部博客进行进行公开，想把这些经验分享给更多的同学，希望对大家有所启发或帮助。
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/eval-evolution.png)
...
从这个意义上讲，自2023年GPT爆火以来，Agent发展从ChatBot形态快速发展至ClaudCode[^claudcode]、OpenClaw这样的多功能长程Agent，Agent能力日渐强大，Agent评测正在从“答案评测”走向“行为评测”。
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/agent-execution-chain.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/metric-gap.png)

这两类指标不能直接映射，中间必须有一层面向任务系统的桥梁指标。我们提供一种分层思路如下：

![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/bridge-metrics.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/objective-subjective.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/turing-alignment.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/essay-rubric.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/expert-knowledge.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/long-horizon-diff.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/chatbot-scenarios.png)

在过去1年的发展中图灵形成了成熟的解决方案，包括人工评测、机器评测，部分案例如下：

![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/turing-cases.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/evaluation-goals.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/skill-user-profile.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/skill-lifecycle.png)

综上，Skill评测的痛点总体可以拆解成三个方面：

![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/skill-pain-points.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/task-definition.png)

prompt定义了我们的问题/诉求，expeted behavior[^expeted]定义了我们预期Agent达成的行为，当我们在正式或测试环境中向Agent发送promt[^expeted]，通过trace获取到长程Agent真实的执行路径，就可以得到（prompt - expeted_behavior - trace）三元组，类似于短程Agent的（query - ground_truth - answer），即可进行评测。

#### 3.2.3 长程Agent评测与短程Agent评测的差异

可以把两者的差异总结如下：

![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/eval-paradigm-diff.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/oss-concepts.png)
...
![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/claw-eval.png)

![](/vibe-reading/images/articles/meituan-official-agent-evaluation-guide/wildclawbench.png)

[^claudcode]: 原文如此，疑为 Claude Code。
[^expeted]: 原文如此，疑为 expected behavior / prompt。

## 相关阅读

- [《Agent 评测白皮书》系列01：Agent 评测全览](/vibe-reading/articles/AI/Agent/Evaluation/Meituan/Official/meituan-official-agent-evaluation-white-paper-01) —— 本文续作，评测体系落地指南
- [Demystifying evals for AI agents](/vibe-reading/articles/AI/Agent/Evaluation/Anthropic/Official/anthropic-official-demystifying-evals-for-ai-agents) —— 本文引用的 Anthropic 评测工程博客（中英对照）
