...
> **原文** [从一次 LLM 调用到完整 Harness，Agent 到底经历了什么？](https://mp.weixin.qq.com/s/kZZac-VBgnQIZeookE9Y8g) · **作者** ivanxxie、davoszhang · **来源** 腾讯技术工程 · **原文发布** 2026-09-07 · **转载** 2026-09-14
...
```python title="LLM 单次调用"
answer = LLM(question)
```

![LLM 单次调用](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-llm-call.png)
...
![Q&A Bot 上下文装配](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-qa-bot-context.png)
...
![ReAct 循环](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-react-loop.png)

Agent 真正的分水岭不是“会思考”，而是建立了 模型 → 动作 → 环境 → 观察 → 模型 的闭环。

```python title="Agent Loop"
while not finished:
...
![Tool Calling 结构](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-tool-calling.png)
...
![记忆系统能力逻辑图](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-memory.png)
...
![Composio 多 Harness 基准测试结果](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-composio-benchmark.png)
...
![Databricks 内部基准：成本与通过率](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-databricks-benchmark.png)
...
![Pi Agent 架构](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-pi-architecture.png)
...
![OpenCode 架构](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-opencode-architecture.png)
...
![OpenBench 七套 Harness 成本对比](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-openbench-cost.png)
...
![Codex 多 Agent 界面](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-codex-multiagent.png)
...
![Thread / Turn / Item 生命周期](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-codex-thread-lifecycle.png)
...
```text title="Thread / Turn / Item 三层结构"
Thread
└── Turn
    ├── User Input Item
...
![PAST-Bench 跨会话测试结果](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-past-bench.png)
...
![Hermes Agent 架构](/vibe-reading/images/articles/tencent-blogs-from-llm-call-to-agent-harness/fig-hermes-architecture.png)
...
- [ReAct: Synergizing Reasoning and Acting in Language Models](/vibe-reading/articles/react-synergizing-reasoning-and-acting) — 本文 ReAct 节的原论文解读，Thought → Action → Observation 循环的出处。
- [MemGPT: Towards LLMs as Operating Systems](/vibe-reading/articles/memgpt-llms-as-operating-systems) — 本文 Memory 节提到的 MemGPT 论文解读，借用操作系统分层存储思想在有限上下文与外部存储之间调度信息。
- [Harness Engineering（驾驭工程）](/vibe-reading/articles/AI/Agent/Harness-Engineering/Blogs/runoob-blogs-harness-engineering) — 围绕 AI 智能体构建约束、反馈与控制系统的方法论，与本文的 Harness 演进视角互补。
- [Loop Engineering 已死？ 一文带你了解Graph Engineering](/vibe-reading/articles/tencent-official-graph-engineering) — 同为腾讯技术工程出品，梳理从 Prompt→Context→Harness→Loop→Graph 的五层演进。
- [Building effective agents](/vibe-reading/articles/anthropic-official-building-effective-agents) — Anthropic 官方的 Agent 设计实践，从五种工作流模式到自主 agent 的设计原则。
