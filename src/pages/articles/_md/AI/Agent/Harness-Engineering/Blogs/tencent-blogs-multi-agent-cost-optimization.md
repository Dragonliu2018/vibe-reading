...
source:
  type: "article"
  project: "Tencent"
  url: "https://mp.weixin.qq.com/s/TIdXNlrcAOUZWVW1oWnnKQ"
  author: "lemonye"
  site: "腾讯程序员"
...
> **原文** [靠这10个优化点，我们把Multi-Agent工作流成本降了50%以上](https://mp.weixin.qq.com/s/TIdXNlrcAOUZWVW1oWnnKQ) · **作者** lemonye · **来源** 腾讯程序员 · **原文发布** 2026-08-21 · **转载** 2026-08-24
...
![tech-leader 工作流结构](/vibe-reading/images/articles/tencent-blogs-multi-agent-cost-optimization/harness-workflow.png)
...
![AgentLens 成本分布](/vibe-reading/images/articles/tencent-blogs-multi-agent-cost-optimization/agentlens-cost-distribution.png)
...
![三个优化原则](/vibe-reading/images/articles/tencent-blogs-multi-agent-cost-optimization/three-principles.png)
...
![渐进式披露三层结构](/vibe-reading/images/articles/tencent-blogs-multi-agent-cost-optimization/progressive-disclosure-layers.png)
...
以 tech-leaderSkill （主调度Skill）为例：
...
改法是把各步骤的详细执行内容拆到 references/ 资源层，SKILL.md 只保留骨架——核心职责、规模预判维度表、分流规则、进度追踪机制、容错机制。
...
![MCP 数据获取子 Agent 化](/vibe-reading/images/articles/tencent-blogs-multi-agent-cost-optimization/mcp-sub-agent.png)
...
![单 Agent 拆分为多 Agent](/vibe-reading/images/articles/tencent-blogs-multi-agent-cost-optimization/single-to-multi-agent.png)
...
```yaml title="backend-dev Agent frontmatter"
---
name: backend-dev
...
![代码图谱替代盲搜](/vibe-reading/images/articles/tencent-blogs-multi-agent-cost-optimization/code-graph-search.png)
...
![rtk 压缩效果](/vibe-reading/images/articles/tencent-blogs-multi-agent-cost-optimization/rtk-compression.png)
...
- [Improving token efficiency in GitHub Agentic Workflows | GitHub Blog](https://github.blog/news-insights/product-news/improving-token-efficiency-in-github-agentic-workflows/)
- [Agent Skill 规范、构建与设计模式 | 阿里技术](https://developer.alibaba.com/agent-skill)
- [rtk-ai/rtk：CLI proxy that reduces LLM token consumption by 60-90% | GitHub](https://github.com/rtk-ai/rtk)

## 相关阅读

- [Harness Engineering（驾驭工程）](/vibe-reading/articles/AI/Agent/Harness-Engineering/Blogs/runoob-blogs-harness-engineering) — AI 模型已经能写出 100 万行代码，真正的挑战是怎么驾驭它稳定、可靠、不失控地工作，围绕 AI 智能体构建约束、反馈与控制系统的方法论 Harness Engineering。
- [Loop Engineering 已死？一文带你了解 Graph Engineering](/vibe-reading/articles/tencent-official-graph-engineering) — 同为腾讯技术工程出品，梳理从 Prompt→Context→Harness→Loop→Graph 的五层演进，拆解 Graph 的四要素与三种编排拓扑。
- [Building effective agents](/vibe-reading/articles/anthropic-official-building-effective-agents) — Anthropic 工程团队总结构建 LLM agent 的实践经验：从增强型 LLM 出发，介绍五种工作流模式及自主 agent 的设计原则。
