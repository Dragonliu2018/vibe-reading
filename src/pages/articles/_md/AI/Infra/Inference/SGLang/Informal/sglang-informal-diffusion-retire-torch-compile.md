---
title: "基于 Agent 在 SGLang Diffusion 中让 Torch Compile 完全退役，细数 Torch Compile 七宗罪"
source:
  type: "article"
  project: "SGLang"
  url: "https://mp.weixin.qq.com/s/7h3Go8vlkcKhT7QegpMngw"
  author: "BBuf"
...
> **原文** [基于 Agent 在 SGLang Diffusion 中让 Torch Compile 完全退役，细数 Torch Compile 七宗罪](https://mp.weixin.qq.com/s/7h3Go8vlkcKhT7QegpMngw) · **作者** BBuf · **来源** 公众号 GiantPandaLLM · **原文发布** 2026-08-10 · **转载** 2026-08-10
...
![Torch Compile mode 参数](/vibe-reading/images/articles/sglang-informal-diffusion-retire-torch-compile/torch-compile-mode-param.png)
...
- 透明性低，没有Torch Compile的时候我们可以非常方便的知道哪些kernel慢对应到Python调用上去，用了Torch Compile之后整个模型的执行时间线在 [https://ui.perfetto.dev/](https://ui.perfetto.dev/) 里面会变成一坨，且通过kernel name很难定位到原始Python调用位置，而且你想去看Torch Compile生成的这个kernel或者对这个kernel做评测以及二次修改也很难。
...
详细数据见：[https://github.com/BBuf/how-to-optim-algorithm-in-cuda/issues/21](https://github.com/BBuf/how-to-optim-algorithm-in-cuda/issues/21)
...
![SGLang Diffusion H100 性能基准测试](/vibe-reading/images/articles/sglang-informal-diffusion-retire-torch-compile/perf-h100-benchmark.png)

![SGLang Diffusion H200 性能基准测试](/vibe-reading/images/articles/sglang-informal-diffusion-retire-torch-compile/perf-h200-benchmark.png)
...
![vae组件优化例子](/vibe-reading/images/articles/sglang-informal-diffusion-retire-torch-compile/vae-optimization-example.png)

![模型优化例子](/vibe-reading/images/articles/sglang-informal-diffusion-retire-torch-compile/model-optimization-example.png)
...
![优化例子展示](/vibe-reading/images/articles/sglang-informal-diffusion-retire-torch-compile/optimization-examples.png)
...
- [https://github.com/BBuf/AI-Infra-Auto-Driven-SKILLS](https://github.com/BBuf/AI-Infra-Auto-Driven-SKILLS)
