...
source:
  type: "article"
  project: "Doris"
  url: "https://doris.apache.org/zh-CN/docs/3.x/gettingStarted/what-is-apache-doris"
  author: "Apache Doris"
  site: "Apache Doris 官方文档"
date: "2026-08-03T13:00:00+08:00"
category: [Database, OLAP, Apache Doris, Docs, "3.x", "01 快速开始"]
...
> **原文** [Apache Doris 简介](https://doris.apache.org/zh-CN/docs/3.x/gettingStarted/what-is-apache-doris) · **作者** Apache Doris · **来源** Apache Doris 官方文档（3.x）· **转载** 2026-08-03
...
![Apache Doris 的使用场景](/vibe-reading/images/articles/doris-official-what-is-apache-doris/apache-doris-usage-scenarios-pipeline-415943571e96b5151d55522929fc8b52.jpeg)
...
![MPP 数据库整体架构和技术特点](/vibe-reading/images/articles/doris-official-what-is-apache-doris/apache-doris-technical-overview-b8c5cb11b57d2f6559fa397d9fd0a8a0.png)
...
![存算分离整体架构和技术特点](/vibe-reading/images/articles/doris-official-what-is-apache-doris/apache-doris-technical-compute-storage-decouple-overview-ba748233b2775dfc5c90472ffd66bda4.jpg)
...
![查询引擎](/vibe-reading/images/articles/doris-official-what-is-apache-doris/apache-doris-query-engine-1-9e2beb07704b905a1c44dae1c5b3bd04.png)

Doris 查询引擎是向量化引擎，所有内存结构均按列式布局，可显著减少虚函数调用，提高缓存命中率，并有效利用 SIMD 指令。在宽表聚合场景下，性能是非向量化引擎的 5-10 倍。

![Doris 查询引擎是向量化](/vibe-reading/images/articles/doris-official-what-is-apache-doris/apache-doris-query-engine-2-92a7d1bd709c09e437e90dfedf559803.png)
...
![pip_exec_3](/vibe-reading/images/articles/doris-official-what-is-apache-doris/pip_exec_3-d0f58e16950b3caba35268d217c5fca8.png)
