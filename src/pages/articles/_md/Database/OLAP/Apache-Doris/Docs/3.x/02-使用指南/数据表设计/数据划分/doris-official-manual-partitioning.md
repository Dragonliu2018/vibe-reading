...
source:
  type: "article"
  project: "Doris"
  url: "https://doris.apache.org/zh-CN/docs/3.x/table-design/data-partitioning/manual-partitioning"
  author: "Apache Doris"
...
> **原文** [手动分区](https://doris.apache.org/zh-CN/docs/3.x/table-design/data-partitioning/manual-partitioning) · **作者** Apache Doris · **来源** Apache Doris 官方文档（3.x）· **转载** 2026-08-04
...
```sql title="FIXED RANGE 语法"
PARTITION BY RANGE(col1[, col2, ...]) (
    PARTITION partition_name1 VALUES [("k1-lower1", "k2-lower1", ...), ("k1-upper1", "k2-upper1", ...)),
...
```sql title="RANGE 无 LESS THAN 分区时插入失败"
