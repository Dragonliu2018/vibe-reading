...
source:
  type: "article"
  project: "Doris"
  url: "https://doris.apache.org/zh-CN/docs/3.x/sql-manual/sql-statements/table-and-view/table/CANCEL-ALTER-TABLE"
  author: "Apache Doris"
...
> **原文** [CANCEL ALTER TABLE](https://doris.apache.org/zh-CN/docs/3.x/sql-manual/sql-statements/table-and-view/table/CANCEL-ALTER-TABLE) · **作者** Apache Doris · **来源** Apache Doris 官方文档（3.x）· **转载** 2026-08-03
...
```sql title="CANCEL ALTER TABLE 语法"
...
```text title="撤销 ALTER CLUSTER（待实现）"
（待实现...）
```
