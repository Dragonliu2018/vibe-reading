...
> **原文** [数据分桶](https://doris.apache.org/zh-CN/docs/3.x/table-design/data-partitioning/data-bucketing) · **作者** Apache Doris · **来源** Apache Doris 官方文档 · **转载** 2026-07-30
...
![p250102 分区根据 region 列划分为 3 个 Hash 分桶](/vibe-reading/images/articles/doris-official-data-bucketing/hash-bucket.png)
...
![8 个批次随机分配到 p250102 的 3 个 Random 分桶](/vibe-reading/images/articles/doris-official-data-bucketing/random-bucket.png)
