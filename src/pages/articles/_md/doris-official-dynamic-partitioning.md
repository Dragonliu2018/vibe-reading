...
source:
  type: "article"
  project: "Doris"
  url: "https://doris.apache.org/zh-CN/docs/3.x/table-design/data-partitioning/dynamic-partitioning"
  author: "Apache Doris"
...
> **原文** [动态分区](https://doris.apache.org/zh-CN/docs/3.x/table-design/data-partitioning/dynamic-partitioning) · **作者** Apache Doris · **来源** Apache Doris 官方文档（3.x）· **转载** 2026-08-04
...
![动态分区生命周期管理](/vibe-reading/images/articles/doris-official-dynamic-partitioning/dynamic-partition.png)
...
上例中创建了动态分区表，详细 dynamic_partition 参数可以参考动态分区参数说明。
