...
source:
  type: "article"
  project: "Doris"
  url: "https://doris.apache.org/zh-CN/docs/3.x/table-design/data-model/unique"
  author: "Apache Doris"
...
> **原文** [主键表](https://doris.apache.org/zh-CN/docs/3.x/table-design/data-model/unique) · **作者** Apache Doris · **来源** Apache Doris 官方文档（3.x）· **转载** 2026-08-03
...
- 部分列更新：如果用户希望更新部分字段，需要使用写时合并实现，并通过特定的参数来开启部分列更新的支持。请查阅文档[部分列更新](https://doris.apache.org/zh-CN/docs/3.x/data-operate/update-update/unique-table-partial-update)。
...
![主键表数据插入与覆盖](/vibe-reading/images/articles/doris-official-unique-table/unique-key-model-insert.png)
...
- 部分列更新。如果用户希望更新部分字段，需要使用写时合并实现，并通过特定的参数来开启部分列更新的支持。请查阅文档[部分列更新](https://doris.apache.org/zh-CN/docs/3.x/data-operate/update-update/unique-table-partial-update)获取相关使用建议；
